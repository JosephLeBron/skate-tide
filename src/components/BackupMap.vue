...
<body>
  ...
  <script>
    ...
    function initMap() {
      map = new google.maps.Map(document.getElementById('map'), {
        center: {lat:  34.225727, lng: -77.944710}, /// centered on wilmington
        zoom: 13
      });
    ...
    const Spots = [
      ["Spot 1", 34.225727, -77.944710, 4], ///set to wilmington
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD14I2uUPhK7oAj5eTT19LAv-M4CY5aYSk&callback=initMap" async defer></script>
